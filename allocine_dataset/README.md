...
User ratings go from 1 to 5 with a step of 0.5 between each.
As we can see, on the following image, there are more positive reviews than negative, with a large peak at 4.
